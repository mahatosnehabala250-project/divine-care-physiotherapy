...
function WhatsAppIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" role="img" aria-label="WhatsApp">
...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-[4.5rem] right-6 sm:bottom-6 z-50 flex items-center gap-3">
      {/* Tooltip */}
      <AnimatePresence>
        {showTooltip && (
          <motion.div
